...
import (
	...
	"github.com/litencatt/go_todo_app/testutil"
...
func TestRepository_AddTask(t *testing.T) {
	...
	mock.ExpectExec(`INSERT INTO task \(user_id, title, status, created, modified\) VALUES \(\?, \?, \?, \?, \?\)`).WithArgs(
		okTask.UserID, okTask.Title, okTask.Status, c.Now(), c.Now(),
